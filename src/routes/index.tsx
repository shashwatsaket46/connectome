...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "ConnectionMiner Experiment Hub — Interactive Experiments" },
      {
        name: "description",
        content:
          "Browse, configure and open self-contained ConnectionMiner experiment dashboards: confusion matrices, UMAP scatters and full solver runs.",
      },
      { property: "og:title", content: "ConnectionMiner Experiment Hub" },
      {
        property: "og:description",
        content:
          "A configurable, menu-driven hub of independently deployable experiment dashboards.",
      },
    ],
  }),
  component: Index,
...
function Index() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-10">
      ...
      <h1 className="mt-2 text-3xl font-semibold tracking-tight">Experiment Hub</h1>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        {visible.map((e) => (
          <Link
            ...
            to="/experiments/$id"
            params={{ id: e.id }}
            className="group flex flex-col gap-2 rounded-xl border border-border bg-card p-5 shadow-sm transition-all hover:-translate-y-0.5 hover:border-primary"
          >
